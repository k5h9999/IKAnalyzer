...
public class Dictionary {
	 ...
	 *            Collection<String>词条列表
	 */
	public void reAddWords(Collection<String> words) {
		// 清空词典
		_MainDict.clearMap();
		addWords(words);
	}
	 ...
	 *            true加载扩展词典
	 */
	public void reLoadDict(boolean loadExtDic) {
		loadMainDict(loadExtDic);
		loadStopWordDict();
		loadQuantifierDict();
	}
	 ...
	 *            true加载扩展词典
	 */
	private void loadMainDict(boolean loadExtDic) {
		// 建立一个主词典实例
